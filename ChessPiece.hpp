...
// Date: 03/04/2025
// A header files that defines ChessPiece base class
...
class ChessPiece {
   ...
   */
   ...
   ChessPiece(const std::string& color, const int& row = -1, const int& col = -1, const bool& movingUp = false, const int& piece_size = 0, const std::string& type = "NONE");
