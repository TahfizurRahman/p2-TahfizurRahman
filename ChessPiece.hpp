...
// Date: 04/15/2025
// A header files that defines ChessPiece
/**
 * @class ChessPiece
...
class ChessPiece {
   ...
   /**
    * @brief Getter for the has_moved_ member
    */
   bool hasMoved() const;

   /**
    * @brief Updates the has_moved_ member to indicate that a ChessPiece has moved from its original position
    */
   void flagMoved();
